...
class SettingDefinitionRegistry
{
    ...
    public function all(): array
    {
        return [
            ...
            'risk.max_trade_amount' => ['group' => 'risk', 'label' => 'Future Maximum Trade Amount (Native Asset)', 'type' => 'float', 'default' => 0.1, 'description' => 'Maximum amount of the chain-native asset per future live trade, such as SOL on Solana or ETH on Ethereum. Not applied to paper accounting.'],
