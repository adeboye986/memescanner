...
class EthereumSwapAttempt extends Model
{
    ...
    {
        return ['signing_armed_at' => 'datetime', 'signing_requested_at' => 'datetime', 'preparation_expires_at' => 'datetime', 'revalidation_data' => 'array', 'transaction_payload' => 'encrypted:array', 'expires_at' => 'datetime', 'submitted_at' => 'datetime', 'confirmed_at' => 'datetime', 'failed_at' => 'datetime'];
    }
